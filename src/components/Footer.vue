    ...
    <div class="container-custom relative z-10">
      <div class="grid md:grid-cols-3 gap-12 mb-16">
        <div>
          <a href="#" class="inline-block text-2xl font-display font-bold tracking-tight mb-4">
            <span class="text-white">wahyu</span>
          ...
          <div class="flex items-center gap-3">
            <a 
              ...
              class="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center 
                     text-zinc-400 hover:text-accent hover:border-accent/50 hover:bg-accent/10 transition-all duration-300"
            >
        ...
        <div>
          ...
          <ul class="space-y-3">
            <li v-for="link in quickLinks" :key="link.label">
              <a 
                :href="link.href" 
                class="text-zinc-500 hover:text-accent transition-colors text-sm"
              >
                {{ link.label }}
              </a>
            </li>
      ...
      <div class="pt-8 border-t border-white/5 flex flex-col sm:flex-row justify-between items-center gap-4">
        <p class="text-zinc-600 text-sm">
          &copy; {{ currentYear }} Wahyu Nur. All rights reserved.
        </p>
        <p class="text-zinc-600 text-sm">
