    ...
    <div class="container-custom relative z-10 pt-24">
      <div class="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
        <div class="order-2 lg:order-1 text-center lg:text-left">
          <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent/10 border border-accent/20 mb-6 animate-fade-in">
          ...
          <h1 class="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-display font-bold leading-tight mb-6 animate-slide-up">
            <span class="text-white">Web</span>
            <br />
            <span class="text-gradient">Developer</span>
          </h1>

          <p class="text-lg text-zinc-400 max-w-xl mx-auto lg:mx-0 mb-8 leading-relaxed animate-slide-up animate-delay-200">
            Membangun aplikasi web yang efisien dan scalable dengan Laravel, 
            PHP, dan teknologi modern lainnya. Berbasis di Pekanbaru, Indonesia.
          </p>

          <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-12 animate-slide-up animate-delay-300">
        ...
        <div class="order-1 lg:order-2 flex justify-center animate-scale-in animate-delay-200">
          <div class="relative">
            <div class="absolute inset-0 bg-gradient-to-br from-accent/30 to-lime-500/30 rounded-3xl blur-2xl opacity-40 animate-pulse-slow"></div>
            <div class="relative w-64 h-64 sm:w-80 sm:h-80 lg:w-96 lg:h-96 rounded-3xl overflow-hidden border-2 border-white/10">
              <img 
      ...
      <div class="absolute bottom-8 left-1/2 -translate-x-1/2 hidden lg:block">
        <a 
          href="#about" 
          class="flex flex-col items-center gap-2 text-zinc-500 hover:text-accent transition-colors"
        >
...
const socials = [
  { name: 'GitHub', url: 'https://github.com/wahyunoerr', icon: GithubIcon },
  { name: 'LinkedIn', url: 'https://www.linkedin.com/in/wahyu-nur-6804112b7', icon: LinkedinIcon },
  { name: 'Instagram', url: 'https://www.instagram.com/whynoerr/', icon: InstagramIcon },
]
</script>
